...
### Создание инфраструктуры - что сделано

- Была создана сервисная учетная запись - diploma - с правами - "k8s.admin", "container-registry.images.puller" "editor"
- Скачана версия terraform 1.5.7
...
### Kubernetes и инфраструктура - что сделано

- K8s и инфраструктура поднимается через [terraform](/terraform/). Файлы k8s-* относятся к разворачиванию kubernetes
...
### Создание тестового приложения - что сделано

- "Приложение" с Dockerfile [находится тут](/app/)
- Образ можно найти на [DockerHub'е](https://hub.docker.com/r/malkops/netology-app)
...
2. Для организации конфигурации использовать helm.
...
### Подготовка cистемы мониторинга и деплой приложения - что сделано
